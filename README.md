...
|--------------|--------------|--------------|------------|
| Alpine | 2.73 | latest, 2.73 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
| Alpine | stable 2.60.2 | 2.60.2 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
