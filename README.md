...
|--------------|--------------|--------------|------------|
| Alpine | 2.81 | latest, 2.81 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
| Alpine | stable 2.73.1 | 2.73.1 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
