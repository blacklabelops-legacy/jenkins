...
|--------------|--------------|--------------|------------|
| Alpine | 2.92 | latest, 2.92 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
| Alpine | stable 2.73.3 | 2.73.3 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
