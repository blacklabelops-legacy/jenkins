...
|--------------|--------------|--------------|------------|
| Alpine | 2.65 | latest, 2.65 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
| Alpine | stable 2.46.3 | 2.46.3 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
