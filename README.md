...
|--------------|--------------|--------------|------------|
| Alpine | 2.74 | latest, 2.74 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
| Alpine | stable 2.60.3 | 2.60.3 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
