...
|--------------|--------------|--------------|------------|
| Alpine | 2.69 | latest, 2.69 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
| Alpine | stable 2.60.1 | 2.60.1 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
