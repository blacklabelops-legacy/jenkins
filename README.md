...
|--------------|--------------|--------------|------------|
| Alpine | latest | latest, alpine | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
| Alpine | 2.46 | 2.46 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
| Alpine | stable 2.32.2 | 2.32.2 | [Dockerfile](https://github.com/blacklabelops/jenkins/blob/master/Dockerfile) |
